...
public class OSDData {
	...
	public void parseRawData(byte[] data){
	    ...
	    //Log.d( TAG, "parseRawData : " + HexUtils.byteToHexStringPrint( data, 0, byteCount ) );
	...
	private void evaluateCommand(byte cmd_, int dataSize){    
	    ...
	    switch(icmd) {
	        ...
	        case OSDCommon.MSP_ATTITUDE:
	            angleX = read16()/10;  //[-180,180]������rollʱ��Ϊ����
	            angleY = read16()/10;  //[-180,180]��ͷ������ʱ��Ϊ��
	            head = read16(); 
	            break;
